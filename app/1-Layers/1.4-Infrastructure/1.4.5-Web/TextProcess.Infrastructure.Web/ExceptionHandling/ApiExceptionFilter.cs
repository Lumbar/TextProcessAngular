namespace TextProcess.Infrastructure.Web.ExceptionHandling
{
    ...
    using TextProcess.Infrastructure.CrossCutting.Exceptions.Domain;
    ...
    public class ApiExceptionFilter : ExceptionFilterAttribute
    {
        ...
        public override void OnException(ExceptionContext context)
        {
            ...
            else if (context.Exception is DomainException)
            {
                ...
                baseResponse.State.ErrorType = Constants.ErrorType.Domain;
                baseResponse.State.ErrorMessage = ex.Message;
